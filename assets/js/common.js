...
$('.tab1 a').click(function() {
  getPage($(this).attr('href'), 'tab1', false);
  return false;
});
$('.tab2 a').click(function() {
  getPage($(this).attr('href'), 'tab2', false);
  return false;
});
$('.tab3 a').click(function() {
  getPage($(this).attr('href'), 'tab3', false);
  return false;
});
$('.tab4 a').click(function() {
  getPage($(this).attr('href'), 'tab4', false);
  return false;
});
