...
define('IS_DEV', ((strtolower(SERVER_NM) == 'localhost') or (strtolower(SERVER_NM) == 'mikedang')));
...
if (IS_DEV) 
{
    ...
    define('APP_ROOT',    realpath(dirname(dirname(__FILE__)) . DIRECTORY_SEPARATOR .'htdocs'));
    define('STATIC_ROOT', '/assets');
    $include_base_path =  realpath(dirname(dirname(__FILE__)) . DIRECTORY_SEPARATOR .'lib');
}
else if (IS_STG) 
{
    ini_set('display_errors', 1);
